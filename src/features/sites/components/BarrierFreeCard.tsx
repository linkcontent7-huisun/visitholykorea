  ...
  return (
    <section>
      <SectionHeading
        as="h3"
        size="md"
        title={t('visitInfoBarrierFree')}
        meta={t('siteLiveSource')}
      />
        ...
        {places.map((place) => (
          ...
          >
            ...
            <div className="min-w-0">
              <h4 className="truncate text-base font-bold text-app-text">{place.title}</h4>
      ...
      <p className="mt-3 text-sm leading-relaxed text-app-text-muted">
        한국관광공사가 수집한 무장애 정보입니다. 성지 내부의 계단·경사는 다를 수 있으니 방문 전 성지
        사무실에 확인하시는 것이 가장 정확합니다.
      </p>
    </section>
  );
}
