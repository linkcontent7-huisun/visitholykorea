 ...
 * 앱의 실제 저장·삭제 동작과 운영자가 확정한 값만 적는다 — 한국어가 원문, 나머지는 번역.
 * 절을 고칠 때는 여섯 언어를 함께 고친다.
 */
...
export const PRIVACY: Record<Language, { title: string; sections: PrivacySection[] }> = {
  ko: {
    ...
    sections: [
      {
        title: '수집하는 항목',
        body: '회원 가입 시 이메일, 비밀번호(해시 형태), 이름 또는 닉네임을 처리합니다. SNS 로그인 시에는 제공업체가 전달하는 계정 식별 정보와 이메일·이름을 처리합니다. 순례 기록에는 성지·방문일·메모·선택한 사진이, 즐겨찾기와 오늘의 성지 일정을 이용하면 선택·응답 내용이 저장됩니다. 기기에만 남기는 방문 표시는 서버에 보내지 않습니다. 현재 위치는 「현재 위치 사용」 중 기기에서만 이용하며 서버에 저장하지 않습니다.',
      },
      {
        title: 'AI 가이드(미카엘) 대화',
      ...
      {
        title: '이용 목적',
        body: '로그인과 본인 확인, 순례 기록·즐겨찾기·AI 대화·오늘의 성지 일정 결과의 저장과 표시에 사용합니다. 순례 후기와 첨부 사진은 다른 이용자에게도 공개됩니다.',
      },
      {
        title: '보유 기간',
        body: '계정 정보와 이에 연결된 순례 기록·사진·즐겨찾기·AI 대화·오늘의 성지 일정 응답은 회원이 서비스를 이용하는 동안 보유합니다. 개별 기록을 지우거나 탈퇴하면 해당 정보를 지체 없이 삭제합니다. 다른 법령에 따라 특정 정보를 보존해야 하는 경우에는 해당 항목만 그 법정 기간 동안 분리해 보관합니다. 기기에 저장된 방문 표시는 계정 탈퇴 시 그 기기에서 삭제되며, 브라우저 저장소를 지워도 삭제됩니다.',
      },
      {
        title: '삭제 방법',
  ...
  en: {
    ...
    sections: [
      ...
      {
        title: 'Why we use it',
        body: 'We use this information to sign you in, verify your identity, and save and show visit records, favorites, AI chats and Today’s Plan results. Visit notes and attached photos are also visible to other users.',
      },
      {
    ...
    sections: [
      {
        ...
        body: 'Al crear una cuenta tratamos tu correo electrónico, tu contraseña (guardada como hash) y tu nombre o apodo. El inicio de sesión social nos proporciona un identificador de cuenta, el correo y el nombre. Los registros de peregrinación contienen el santuario, la fecha de visita, la nota y las fotos opcionales. Los favoritos y las respuestas del Plan de santuarios de hoy se guardan cuando usas esas funciones. Las marcas de visita que solo se guardan en el dispositivo no se envían a nuestro servidor. Tu ubicación se usa en tu dispositivo mientras el acceso a la ubicación está activado y no se guarda en nuestro servidor.',
      },
      {
      ...
      },
      {
        ...
        body: 'Usamos esta información para iniciar tu sesión, verificar tu identidad, y guardar y mostrar los registros de peregrinación, favoritos, conversaciones de IA y resultados del Plan de santuarios de hoy. Las notas de visita y las fotos adjuntas también son visibles para otros usuarios.',
      },
      {
        title: 'Plazo de conservación',
        body: 'Los datos de la cuenta y los registros de peregrinación, fotos, favoritos, conversaciones de IA y respuestas del Plan de santuarios de hoy vinculados se conservan mientras uses el servicio. Eliminamos un registro cuando lo borras, y eliminamos sin demora la información vinculada a la cuenta cuando la cierras. Si otra ley exige conservar cierta información, solo esa información se guarda por separado durante el plazo exigido. Las marcas de visita del dispositivo se eliminan de ese dispositivo al borrar la cuenta o al vaciar el almacenamiento del navegador.',
      },
      {
        title: 'Cómo eliminar',
        body: 'Puedes eliminar cada registro de peregrinación en «Mis notas». Para cerrar la cuenta, inicia sesión y elige «Más → Ajustes de la cuenta → Eliminar cuenta». La información vinculada, incluidas las fotos originales y las notas públicas, se elimina antes que la cuenta. Si no puedes iniciar sesión, solicita la eliminación por el correo de abajo. Verificamos tu identidad, actuamos sin demora y te comunicamos el resultado por correo en un plazo de 10 días desde la recepción de la solicitud. Los archivos electrónicos se eliminan de forma que no puedan recuperarse.',
      },
      {
        title: 'Consultas y reclamaciones sobre privacidad',
        body: 'El equipo de operaciones de Visit Holy Korea atiende las consultas y reclamaciones sobre privacidad. Correo: visitholykorea@gmail.com',
      },
      {
        title: 'Servicios de terceros',
        body: 'La autenticación y el almacenamiento de datos usan Supabase; el alojamiento web usa Vercel. La información turística cercana y la afluencia prevista se obtienen en tiempo real de la OpenAPI de la Organización de Turismo de Corea (TourAPI) y las respuestas no se guardan. Los mapas externos (Google, Apple, Kakao, T map, Naver) se abren solo mediante enlace y siguen sus propias políticas.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: 'Lors de la création d’un compte, nous traitons votre adresse e-mail, votre mot de passe (stocké sous forme de hachage) et votre nom ou pseudonyme. La connexion sociale nous fournit un identifiant de compte, l’e-mail et le nom. Le carnet de pèlerinage contient le sanctuaire, la date de visite, la note et les photos facultatives. Les favoris et les réponses du Plan de sanctuaires du jour sont enregistrés lorsque vous utilisez ces fonctions. Les marques de visite conservées uniquement sur l’appareil ne sont pas envoyées à notre serveur. Votre position est utilisée sur votre appareil tant que l’accès à la position est activé et n’est pas stockée sur notre serveur.',
      },
      {
      ...
      {
        title: 'Finalités',
        body: 'Nous utilisons ces informations pour vous connecter, vérifier votre identité, et enregistrer et afficher le carnet de pèlerinage, les favoris, les conversations IA et les résultats du Plan de sanctuaires du jour. Les notes de visite et les photos jointes sont également visibles par les autres utilisateurs.',
      },
      {
        title: 'Durée de conservation',
        body: 'Les données du compte et le carnet de pèlerinage, les photos, favoris, conversations IA et réponses du Plan de sanctuaires du jour qui y sont liés sont conservés tant que vous utilisez le service. Nous supprimons une note lorsque vous l’effacez, et supprimons sans délai les informations liées au compte lorsque vous le fermez. Si une autre loi impose la conservation de certaines informations, seules celles-ci sont conservées séparément pendant la durée requise. Les marques de visite de l’appareil sont retirées de cet appareil lorsque vous supprimez votre compte ou videz le stockage du navigateur.',
      },
      {
        title: 'Comment supprimer',
        body: 'Supprimez chaque note de visite dans « Mes notes ». Pour fermer votre compte, connectez-vous et choisissez « Plus → Paramètres du compte → Supprimer le compte ». Les informations liées, y compris les photos originales et les notes publiques, sont supprimées avant le compte. Si vous ne pouvez pas vous connecter, demandez la suppression par e-mail ci-dessous. Nous vérifions votre identité, agissons sans délai et vous communiquons le résultat par e-mail dans les 10 jours suivant la réception de la demande. Les fichiers électroniques sont supprimés de façon irrécupérable.',
      },
      {
        title: 'Questions et réclamations sur la confidentialité',
        body: 'L’équipe d’exploitation de Visit Holy Korea traite les questions et réclamations relatives à la confidentialité. E-mail : visitholykorea@gmail.com',
      },
      {
        title: 'Services tiers',
        body: 'L’authentification et le stockage des données utilisent Supabase ; l’hébergement web utilise Vercel. Les informations touristiques à proximité et l’affluence prévue sont récupérées en temps réel via l’OpenAPI de l’Office du tourisme de Corée (TourAPI) et les réponses ne sont pas stockées. Les cartes externes (Google, Apple, Kakao, T map, Naver) s’ouvrent uniquement par lien et suivent leurs propres politiques.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: 'Ao criar uma conta, tratamos seu e-mail, sua senha (armazenada como hash) e seu nome ou apelido. O login social nos fornece um identificador de conta, o e-mail e o nome. Os registros de peregrinação contêm o santuário, a data da visita, a nota e as fotos opcionais. Os favoritos e as respostas do Plano de santuários de hoje são salvos quando você usa essas funções. As marcas de visita guardadas apenas no dispositivo não são enviadas ao nosso servidor. Sua localização é usada no seu dispositivo enquanto o acesso à localização está ativado e não é armazenada no nosso servidor.',
      },
      {
      ...
      },
      {
        ...
        body: 'Usamos essas informações para fazer seu login, verificar sua identidade, e salvar e exibir registros de peregrinação, favoritos, conversas de IA e resultados do Plano de santuários de hoje. As notas de visita e as fotos anexadas também ficam visíveis para outros usuários.',
      },
      {
        title: 'Prazo de retenção',
        body: 'Os dados da conta e os registros de peregrinação, fotos, favoritos, conversas de IA e respostas do Plano de santuários de hoje vinculados são mantidos enquanto você usa o serviço. Excluímos um registro quando você o apaga e excluímos sem demora as informações vinculadas à conta quando você a encerra. Se outra lei exigir a retenção de determinadas informações, apenas elas são mantidas separadamente pelo prazo exigido. As marcas de visita do dispositivo são removidas desse dispositivo quando você exclui a conta ou limpa o armazenamento do navegador.',
      },
      {
        title: 'Como excluir',
        body: 'Exclua cada registro de peregrinação em “Meus registros”. Para encerrar a conta, faça login e escolha “Mais → Configurações da conta → Excluir conta”. As informações vinculadas, incluindo fotos originais e notas públicas, são removidas antes da conta. Se não conseguir fazer login, solicite a exclusão pelo e-mail abaixo. Verificamos sua identidade, agimos sem demora e informamos o resultado por e-mail em até 10 dias após o recebimento do pedido. Os arquivos eletrônicos são excluídos de forma irrecuperável.',
      },
      {
        title: 'Dúvidas e reclamações sobre privacidade',
        body: 'A equipe de operações do Visit Holy Korea trata das dúvidas e reclamações sobre privacidade. E-mail: visitholykorea@gmail.com',
      },
      {
        title: 'Serviços de terceiros',
        body: 'A autenticação e o armazenamento de dados usam o Supabase; a hospedagem web usa a Vercel. As informações turísticas próximas e o movimento previsto são obtidos em tempo real da OpenAPI da Organização de Turismo da Coreia (TourAPI), e as respostas não são armazenadas. Os mapas externos (Google, Apple, Kakao, T map, Naver) abrem apenas por link e seguem suas próprias políticas.',
      },
    ],
  },
    ...
    sections: [
      {
        ...
        body: 'Quando crei un account trattiamo il tuo indirizzo e-mail, la password (conservata come hash) e il nome o nickname. L’accesso social ci fornisce un identificativo dell’account, l’e-mail e il nome. Il diario di pellegrinaggio contiene il santuario, la data della visita, la nota e le foto facoltative. I preferiti e le risposte del Piano dei santuari di oggi vengono salvati quando usi quelle funzioni. I segni di visita conservati solo sul dispositivo non vengono inviati al nostro server. La tua posizione è usata sul tuo dispositivo finché l’accesso alla posizione è attivo e non viene memorizzata sul nostro server.',
      },
      {
      ...
      {
        title: 'Finalità',
        body: 'Usiamo queste informazioni per farti accedere, verificare la tua identità, e salvare e mostrare diario di pellegrinaggio, preferiti, conversazioni IA e risultati del Piano dei santuari di oggi. Le note di visita e le foto allegate sono visibili anche agli altri utenti.',
      },
      {
        title: 'Periodo di conservazione',
        body: 'I dati dell’account e il diario di pellegrinaggio, le foto, i preferiti, le conversazioni IA e le risposte del Piano dei santuari di oggi collegati vengono conservati finché usi il servizio. Eliminiamo una nota quando la cancelli ed eliminiamo senza ritardo le informazioni collegate all’account quando lo chiudi. Se un’altra legge impone la conservazione di determinate informazioni, solo quelle vengono conservate separatamente per il periodo richiesto. I segni di visita del dispositivo vengono rimossi da quel dispositivo quando elimini l’account o svuoti la memoria del browser.',
      },
      {
        title: 'Come eliminare',
        body: 'Elimina ogni nota di visita in «Le mie note». Per chiudere l’account, accedi e scegli «Altro → Impostazioni account → Elimina account». Le informazioni collegate, comprese le foto originali e le note pubbliche, vengono rimosse prima dell’account. Se non riesci ad accedere, richiedi l’eliminazione via e-mail qui sotto. Verifichiamo la tua identità, procediamo senza ritardo e comunichiamo l’esito via e-mail entro 10 giorni dal ricevimento della richiesta. I file elettronici vengono eliminati in modo irrecuperabile.',
      },
      {
