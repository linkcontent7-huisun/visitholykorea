...
export const DICTIONARY = {
  ...
  heroBodyCount: {
    ko: '전국 성지 {count}곳, 실시간 붐빔 정보와 함께.',
    en: '{count} shrines nationwide, with live crowd estimates.',
  ...
  crowdingEstimateNote: {
    ko: '붐빔 지수는 한국관광공사 실시간 축제·관광 정보로 계산한 추정값입니다. 실제 현장과 다를 수 있어요.',
    en: 'The crowd index is an estimate based on real-time festival and tourism data from the Korea Tourism Organization. It may differ from the actual scene.',
  ...
  alternativeReasonTemplate: {
    ko: '{origin}보다 {relief}점 한적합니다 · {closer}',
    en: '{relief} points quieter than {origin} · {closer}',
    es: '{relief} puntos más tranquilo que {origin} · {closer}',
    fr: '{relief} points plus calme que {origin} · {closer}',
    pt: '{relief} pontos mais tranquilo que {origin} · {closer}',
    it: '{relief} punti più tranquillo di {origin} · {closer}',
  },
