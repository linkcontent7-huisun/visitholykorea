    ...
    <div className="bg-app-bg pb-10">
      ...
      */}
      ...
      <PageContainer className="pt-8 lg:pt-12">
        ...
        <Link
          to={paths.compass}
          className="mb-6 flex w-full items-center gap-4 rounded-[20px] border border-app-border bg-white p-5 text-left shadow-sm lg:max-w-[520px]"
          id="healing-quiz-cta"
        >
          ...
          <div className="flex-1">
            <p className="mb-0.5 text-sm font-extrabold text-app-text">{t('compassCtaTitle')}</p>
            <p className="text-[11px] font-medium text-app-text-muted">{t('compassCtaSubtitle')}</p>
          </div>
