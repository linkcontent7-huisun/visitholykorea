...
순례 기록처럼 "나의 기록"을 남기는 기능만 로그인이 필요합니다.`,
    ...
    {
      q: '수집하는 개인정보는 무엇인가요?',
      a: `이메일 주소와 이름(또는 닉네임)만 수집합니다. 간편 로그인 시에도 본인 식별에 필요한 이 두 가지만 제공받으며, 그 외 정보는 요청하지 않습니다. 자세한 내용은 이용약관에서 확인할 수 있습니다.`,
    },
  ],
  '서비스 이용': [
    {
      q: 'Visit Holy Korea 가 무엇인가요?',
      a: `한국 가톨릭 성지 208곳을 안내하는 순례 웹앱입니다. 성지 소개와 지도, 박해의 역사를 따라 걷는 순례 코스, 감정 기반 성지 추천, 순례 기록 기능을 제공합니다.`,
    },
    {
