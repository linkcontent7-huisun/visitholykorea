  ...
  return (
    <div className="bg-app-bg lg:flex lg:h-[calc(100dvh-72px)] lg:overflow-hidden">
      ...
      >
        ...
        {!wideView && selectedCard && <div className="mt-4 px-4 lg:px-6">{selectedCard}</div>}

        {/* 검색 */}
        <div className="mt-6 px-4 lg:mt-2 lg:px-6">
        ...
        <div className="space-y-3 px-4 py-6 pb-32 lg:px-6 lg:pb-6">
          {isLoading ? (
        ...
        <div className="px-4 pb-10 lg:px-6 lg:pb-8">
